...
/** The trait contains tests for all file-based data sources. The tests that are not applicable to all file-based data
  * sources should be placed to [[org.apache.spark.sql.FileBasedDataSourceSuite]].
  */
