...
class ExtendedAnalysisException private (
  ...
  @transient plan: Option[LogicalPlan] = None,
  ...
  def this(e: AnalysisException, plan: LogicalPlan) = {
    this(e.message, e.line, e.startPosition, Option(plan), e.cause, e.errorClass, e.messageParameters)
  ...
  override def copy(
    ...
    new ExtendedAnalysisException(message, line, startPosition, plan, cause, errorClass, messageParameters)
  }
